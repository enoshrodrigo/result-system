...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('certificate_level_ones', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->unsignedBigInteger('level_student_id');
            $table->unsignedBigInteger('level_course_id');
            $table->string('language_paper',10);
            $table->string('Speech_and_listening',10);
    ...
    {
        Schema::dropIfExists('certificate_level_ones');
    }
};
